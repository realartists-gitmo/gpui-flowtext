...
impl RichTextEditor {
  pub fn dispatch_window_command(&mut self, command: RichTextEditorCommand, window: &mut Window, cx: &mut Context<Self>) {
    ...
    match command {
      ...
      Undo => self.undo(cx),
      Redo => self.redo(cx),
      SetParagraphPocket => self.set_paragraph_style_for_selection(ParagraphStyle::Pocket, cx),
      SetParagraphHat => self.set_paragraph_style_for_selection(ParagraphStyle::Hat, cx),
      SetParagraphBlock => self.set_paragraph_style_for_selection(ParagraphStyle::Block, cx),
      SetParagraphTag => self.set_paragraph_style_for_selection(ParagraphStyle::Tag, cx),
      SetParagraphAnalytic => self.set_paragraph_style_for_selection(ParagraphStyle::Analytic, cx),
      SetParagraphUndertag => self.set_paragraph_style_for_selection(ParagraphStyle::Undertag, cx),
      ToggleCite => self.toggle_cite(cx),
      ToggleUnderline => self.toggle_underline(cx),
      ToggleStrikethrough => self.toggle_strikethrough(cx),
      ToggleEmphasis => self.toggle_emphasis(cx),
      SetHighlightSpoken => self.set_highlight(HighlightStyle::Spoken, cx),
